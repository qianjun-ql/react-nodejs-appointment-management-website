...
const Home = () => {
  ...
  <>
  {/* ===========hero section=========== */}
  <section className='hero__section pt-[60px] 2xl:h-[852px]'>
            ...
            <div className='lg:w-[470px] mx-auto'>
              <h2 className='heading text-center '>
                ...
                <p className='text__para text-center'>
                  World-class care for everyone. One health system offers unmatched, expert health care.
                  </p>
            </div>
            ...
            <div className='py-[30px] px-5'>
              ...
              <div className='mt-[30px]'>
                ...
                <p className='text-[16px] leading-7 text-textColor font-[400] mt-4 text-center'>
                  World-class care for everyone. One health system offers unmatched, expert health care. From the lab to the clinic.
                  </p>
              </div>
        ...
        <section>
          <div className="container">
            <div className="xl:w-[470px] mx-auto ">
              ...
              <p className='text__para text-center'>
                World-class care fore everyone. Our health system offers unmatched, expert health care.
                </p>
            </div>
