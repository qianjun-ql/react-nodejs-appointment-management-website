...
const Profile = ({doctorData}) => {
    ...
    // reusable method for adding item
    const addItem = (key, item) => {
        setFormData(prevFormData => ({...prevFormData, [key]: [...prevFormData[key], item]}))
    }

    // reusable input change method
        ...
        <form>
            ...
            <div className="mb-5">
                <div className='grid grid-cols-3 gap-5 mb-[30px]'>
                    <div>
                    <p className='form__label'>Pronouns*</p>
                    <select 
                    name="pronouns" 
                    ...
                    <div>
                        <p className='form__label'>Tiket Price*</p>
                        <input 
                        type="number" 
                        placeholder='100' 
                        name="ticketPrice" 
