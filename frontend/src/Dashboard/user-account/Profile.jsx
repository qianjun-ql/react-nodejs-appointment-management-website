...
const Profile = ({user}) => {
  ...
  useEffect(() =>  {
    setFormData({ name: user.name, email: user.email, photo: user.photo, pronouns: user.pronouns, bloodType: user.bloodType})
  }, [user]);
  ...
  return (
    ...
    <form onSubmit={submitHandler}>
      <div className="mb-5">
        ...
        className='w-full  pr-4 py-3 border-b border-solid border-[#0066ff61] focus:outline-none focus:border-b-primaryColor text-[16px] text-headingColor leading-7 placeholder:text-textColor cursor-pointer'
        required
        />
      </div>
      <div className="mb-5">
      ...
      <div className='mb-5 flex items-center gap-3'>
        ...
        <div className='relative w-[130px] h-[50px]'>
          ...
          {selectedFile && selectedFile.name ? selectedFile.name : 'Upload Photo'}
